...
Exemplo: localhost:8080/categorias
```

#### *Paginado Escolher Pagina*
```text
localhost:8080/§tabela§?page=§pagina§

Exemplo: localhost:8080/categorias?page=2
```

#### *Paginado Tamanho Diferente*
```text
localhost:8080/§tabela§?size=§size§

Exemplo: localhost:8080/categorias?size=5
```

*(Nota: Mudar o tamanho & Escolher a pagina no paginado podem ser feitos junto)*
\
Exemplo:
```text
localhost:8080/categorias?size=5&page=4
```
...
Exemplo: localhost:8080/categorias/todas
```

#### *Filtro
```text
localhost:8080/§tabela§?nome=§nome§

Exemplo: localhost:8080/categorias?nome=ac
```
#### *Unico*
```text
