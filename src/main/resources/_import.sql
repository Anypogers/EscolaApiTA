...
insert into tb_forma_pagamento (id, DescricaoForma) values (1, 'Cartão de crédito');
insert into tb_forma_pagamento (id, DescricaoForma) values (2, 'Cartão de débito');
insert into tb_forma_pagamento (id, DescricaoForma) values (3, 'Dinheiro');
...
insert into tb_restaurante_tb_forma_pagamento (restaurante_id, forma_pagamento_id) values (1, 1), (1, 2), (1, 3), (2, 3), (3, 2), (3, 3), (4, 1), (4, 2), (5, 1), (5, 2), (6, 3);
