...
alter table tb_restaurante_forma_pagamento add constraint fk_restaurante_forma_pagto_forma_pagto
foreign key (forma_pagamento_id) references tb_forma_pagamento(id);

alter table tb_restaurante_forma_pagamento add constraint fk_restaurante_forma_pagto_restaurante
foreign key (restaurante_id) references tb_restaurante(id);
